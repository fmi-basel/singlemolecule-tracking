...
```commandline
WD=runs/feature-extraction pixi run calculate_distance-to-nucleus
```
...
```commandline
WD=runs/feature-extraction pixi run cell_compartments
```
...
```commandline
WD=runs/feature-extraction pixi run nuc_dist_edge_dist
```