...
```commandline
WD=runs/preprocessing pixi run iNeuron_single_slices
```
...
```commandline
WD=runs/preprocessing pixi run merge_raw_denoised_image
```
...
```commandline
WD=runs/preprocessing pixi run file_renaming
```